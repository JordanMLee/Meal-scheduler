...
namespace Lee_Hooymans_V1
{
    public class CCadet
    {
        ...
        public void exportdata()
        {
            ...
            System.IO.File.WriteAllText(@"C:\Users\JAHooymans\CadetTest.csv", text);
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"C:\Users\JAHooymans\CadetTest.csv", true))
            {
